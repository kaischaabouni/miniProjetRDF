...
public class Test500For4Triplets {

	public static final String EXECTIMEFILEDEFAULTPATH = "eval500For4Triplets";
	...
	public static void main(String[] args) {
		...
		String queriesDirecoryPath = "assets/queries by triplets/4/";  
		if(args.length == 2){
			filePath = args[0];
